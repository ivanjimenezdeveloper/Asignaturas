...
public class Ficha extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (id == 0) {
			...
			response.getWriter().print(htmlLogged(user, id));
		} else {

			response.getWriter().print(htmlNoLogged(id));
		}
	...
	protected String crearFicha(int id) {
		...
		ficha += "		<div class=\"ficha\">\n" + "			<div class=\"fichaImagen\"></div>\n"
				...
				+ "					<p class=\"fichaDescripcion\">" + Nombre.nombrePlataforma(game.getIdPlataforma())
				+ "</p>\n" + "				</div>\n" + "				<div class=\"fichaRow\">\n"
