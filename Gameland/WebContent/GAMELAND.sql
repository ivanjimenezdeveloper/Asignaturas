...
UPDATE JUEGO SET TITULO = "ASDA", ANYO = 89, FOTO="FOTICO", DESCRIPCION = "DESCRIPCION DE UPDATE", IDGENERO = 2, IDPLATAFORMA = 3
  WHERE ID= 2;
...
,("FIFA", 2014, "PRUEBA", "DOÑA ASEME EL CORTE DE SERRESIETE", 2,2 )
...
SELECT * FROM JUEGO WHERE TITULO LIKE "%EMPIRES%";

SELECT * FROM JUEGO;

SELECT * FROM USUARIO;

INSERT INTO USUARIO(NOMBRE,USUARIO,PASS,FOTO,ADMINISTRADOR) VALUES("ADMIN","123","123","FOTO",1);

SELECT * FROM PLATAFORMA;

DELETE FROM JUEGO WHERE ID = 5;
