...
public class PaginaPrincipal {
	...
	public void muestra(PrintWriter out, ArrayList<Usuario> listaUsuarios, Usuario usuario) {
		...
		if(usuario == null) {
			...
			out.println("<a href=\"Crear\"> Añadir un nuevo usuario </a>");
			out.println("<br/>");
			out.println("<br/>");
			...
			for(Usuario u: listaUsuarios) {
				...
				out.println("<TD><A href=\"Editar?id="+u.getId()+"\"> <img src=\"edit.png\" /> </A></TD>");
				out.println("<TD><A href=\"Eliminar?id="+u.getId()+"\"> <img src=\"delete.png\" /> </A></TD>");
				out.println("</TR>");
			}
			out.println("</TABLE>");
		}
