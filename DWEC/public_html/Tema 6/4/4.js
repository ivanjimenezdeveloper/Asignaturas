...
function mayor18() {
    ...
    if (age < 18)
        document.getElementById("mayor").innerHTML = "USTET NO PODIA ERA PEQUENIO TENIA: " + age;
...
function almenosTres() {
    ...
    if (xekeaos < 3) {
        document.getElementById("ckFunciona").innerHTML = "NO";
        return false;
    } else {
        document.getElementById("ckFunciona").innerHTML = "SI";
